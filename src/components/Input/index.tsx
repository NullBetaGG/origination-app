...
export default function Input({
  ...
  return (
    <div className={`flex flex-col ${componentStyle}`}>
      ...
      <div
        className={`border-[1px] border-neutral-900 rounded-base inputContainer overflow-hidden focus-within:border-primary-900 flex items-center w-full transition-colors duration-200 ${containerStyle} ${props.disabled ? "bg-neutral-200" : "bg-transparent"
          } `}
      >
